...
const userSchema = mongoose.Schema({
    ...
    // hash created by combining pw provided by user and the salt + 
    // applying one-way encryption
    hash: String,
    ...
    alerts: [{type: mongoose.Schema.ObjectId, ref: 'Alert'}],
    // motivation: [{ type: mongoose.Schema.ObjectId, ref: 'Motivation' }],

    // FOR NURSES ONLY ------------------------------------------------
    receivedEmergencyAlerts: [{ type: mongoose.Schema.ObjectId, ref: 'Alert' }],
